...
public class ArticleServiceNSFTest {
    ...
    @Test
    public void minMaxNormalize_정상_정규화() throws Exception {
        // given
        ...
        // when
        Method method = ArticleService.class.getDeclaredMethod("minMaxNormalize", Map.class);
        method.setAccessible(true);
        @SuppressWarnings("unchecked")
        Map<Long, Double> result = (Map<Long, Double>) method.invoke(articleService, scores);
    ...
    @Test
    public void minMaxNormalize_동일한_점수() throws Exception {
    ...
    @Test
    public void minMaxNormalize_빈_맵() throws Exception {
        // given
        Map<Long, Double> scores = new HashMap<>();
    ...
    @Test
    public void minMaxNormalize_단일_항목() throws Exception {
        // given
        Map<Long, Double> scores = new HashMap<>();
        scores.put(1L, 7.0);
    ...
    @Test
    public void calculateNSFScores_BM25만_있을때() throws Exception {
        // given
        ...
        // when
        Method method = ArticleService.class.getDeclaredMethod("calculateNSFScores",
                Map.class, Map.class, Map.class, Map.class);
        method.setAccessible(true);
        @SuppressWarnings("unchecked")
        Map<Long, Double> result = (Map<Long, Double>) method.invoke(articleService,
    ...
    @Test
    public void calculateNSFScores_모든_검색방법_결합() throws Exception {
        // given
        Map<Long, Double> bm25Scores = new HashMap<>();
        bm25Scores.put(1L, 10.0);
        bm25Scores.put(2L, 5.0);
    ...
    @Test
    public void calculateNSFScores_벡터_전용_결과_포함() throws Exception {
    ...
    @Test
    public void calculateTitleCoverageWeight_빈_제목() throws Exception {
        // when
        Method method = ArticleService.class.getDeclaredMethod("calculateTitleCoverageWeight", String.class, int.class);
        method.setAccessible(true);
        double result = (double) method.invoke(articleService, "", 5);
    ...
    @Test
    public void calculateTitleCoverageWeight_높은_커버리지() throws Exception {
        ...
        Method method = ArticleService.class.getDeclaredMethod("calculateTitleCoverageWeight", String.class, int.class);
        method.setAccessible(true);
        double result = (double) method.invoke(articleService, title, keywordLength);
    ...
    @Test
    public void calculateTitleCoverageWeight_낮은_커버리지() throws Exception {
