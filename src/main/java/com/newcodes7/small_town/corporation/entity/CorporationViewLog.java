...
@Entity
@Table(name = "corporation_view_log",
       indexes = {
...
public class CorporationViewLog {
    ...
    // 인증된 사용자용 생성자
    public CorporationViewLog(Corporation corporation, User user, String ipAddress) {
    ...
    // 익명 사용자용 생성자
    public CorporationViewLog(Corporation corporation, String ipAddress) {
        this.corporation = corporation;
        this.ipAddress = ipAddress;
    }
