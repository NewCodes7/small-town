...
public class ThemeViewLog {
    ...
    // 인증된 사용자용 생성자
    public ThemeViewLog(Theme theme, User user, String ipAddress) {
        this.theme = theme;
        this.user = user;
    ...
    // 익명 사용자용 생성자
    public ThemeViewLog(Theme theme, String ipAddress) {
        this.theme = theme;
        this.ipAddress = ipAddress;
    }
