...
public class AdminArticleController {
    ...
    public String articleList(
        ...
        model.addAttribute("searchQualityStats", data.getSearchQualityStats());
        model.addAttribute("topClickedContent", data.getTopClickedContent());
        model.addAttribute("recentClickLogs", data.getRecentClickLogs());
