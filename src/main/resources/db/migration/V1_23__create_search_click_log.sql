...
CREATE INDEX idx_scl_keyword_created ON search_click_log (search_keyword, created_at DESC);
CREATE INDEX idx_scl_article_created ON search_click_log (article_id, created_at DESC);
CREATE INDEX idx_scl_search_log_id   ON search_click_log (search_log_id);
CREATE INDEX idx_scl_user_id         ON search_click_log (user_id);
